...
for (var i = 0; i < mainArray.length; i++)  {
    li += `<li class="column" draggable="true"> <header style="background-color: ${mainArray[i]};">${mainArray[i]} <span><b style="float:right"><button><img src="/resources/images/trash.png" width="15"></button onclick=remove(i)></b></span></header>
